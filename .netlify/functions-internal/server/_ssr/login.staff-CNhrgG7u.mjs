...
function StaffLogin() {
	...
	const [email, setEmail] = (0, import_react.useState)("staff@capsl.com");
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: "Field Staff Portal"
					})] })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex h-14 w-14 items-center justify-center rounded-2xl bg-[oklch(0.78_0.17_60)]/20 text-[oklch(0.85_0.18_60)]",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HardHat, { className: "h-7 w-7" })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "mt-6 text-3xl font-semibold tracking-tight",
						children: "Field staff sign in"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 max-w-md text-sm text-sidebar-foreground/70",
						children: "Log in to the site you're working from today. Every report you raise will be geo-tagged to that location automatically."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
						className: "mt-6 space-y-2 text-sm text-sidebar-foreground/70",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "• Submit near-misses, unsafe acts and incidents" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "• Assign action items to teammates with due dates" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "• Track your own submission and close-out analytics" })
						]
					})
				] }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						...
						children: "Sign in as Field Staff"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-1 text-sm text-muted-foreground",
						children: "Select the location you're currently working from."
					}),
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Label, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "h-3.5 w-3.5" }), " Current work location"]
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								children: busy ? "Signing in…" : "Sign in to this site"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							className: "mt-1",
							children: "staff@capsl.com / staff123"
						})]
					}),
