...
import { C as isResolvedRedirect, D as invariant, S as isRedirect, T as isNotFound, a as RouterProvider, b as resolveManifestAssetLink, t as renderRouterToStream, w as rootRouteId, x as executeRewriteInput } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CsPLmRO2.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cww_9lSV.mjs"),
		import("./start-Boqis18p.mjs"),
